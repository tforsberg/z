...
(function (Application) {
    (function (Directives) {
        ...
        var CcImgPersonDirective = (function () {
            function CcImgPersonDirective() {
            }
            CcImgPersonDirective.prototype.createDirective = function () {
                return {
                    restrict: 'E',
                    template: ''
                };
            };
            return CcImgPersonDirective;
        })();
        Directives.CcImgPersonDirective = CcImgPersonDirective;
