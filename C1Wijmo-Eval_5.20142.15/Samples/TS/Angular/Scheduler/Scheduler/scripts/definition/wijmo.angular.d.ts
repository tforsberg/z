...
declare module wijmo.angular {
    ...
    class WjLink {
        ...
        public _isAttrInitialized(name: string): boolean;
        public _allAttrInitialized(): boolean;
        public _beginAttrInit(name: string): void;
        public _endAttrInit(name: string): void;
        private _prepareAttrsInit();
    ...
    class PropDesc {
        ...
        private _priority;
        constructor(propertyName: string, propertyType: PropertyType, scopeBindingMode: string, enumType?: any, customHandler?: (scope: ng.IScope, control: Control, value: any, oldValue: any, link: WjLink) => void, isNativeControlProperty?: boolean, priority?: number);
