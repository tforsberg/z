<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.Master" AutoEventWireup="true"
	CodeBehind="Negative.aspx.cs" Inherits="ToolkitExplorer.BubbleChart.Negative" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Description" runat="server">
	<p>
		The bubble chart can handle negative x and y axis values. This sample demonstrates
		rendering negative and positive numbers in the same chart.</p>
</asp:Content>
