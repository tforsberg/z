<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.master" AutoEventWireup="true" CodeFile="Overview.aspx.cs" Inherits="Tabs_Overview" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="server">
	<p>
    The TabsExtender converts an ASP.NET Panel control with specified content sections into a tabbed UI element. 
    The following samples will introduce you to several features of the TabsExtender.
	</p>
</asp:Content>
