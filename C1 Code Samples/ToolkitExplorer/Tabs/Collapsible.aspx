<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.master" AutoEventWireup="true" CodeFile="Collapsible.aspx.cs" Inherits="Tabs_Collapsible" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <wijmo:C1TabsExtender ID="TabsExtender1" runat="server" TargetControlID="Panel1" Collapsible="true" />
...
<p>
C1TabsExtender supports collapsing content of tab page.
</p>

<p>
Content of a tab will be collapsed when you click it if the <b>Collapsible</b> property is set to true. Clicking a collapsed tab would expand it again.
</p>

<p>
When you try the sample, open a tab and then click on it once more, the tab will automatically collapse.
</p>
