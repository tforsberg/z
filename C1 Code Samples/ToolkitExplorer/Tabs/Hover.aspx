<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.master" AutoEventWireup="true" CodeFile="Hover.aspx.cs" Inherits="Tabs_Hover" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <wijmo:C1TabsExtender ID="TabsExtender1" runat="server" TargetControlID="Panel1" Event="mouseover" />

</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="server">

<p>
C1TabsExtender supports opening tabs when moving the mouse over it.
</p>

<p>
This behavior is enabled if the <b>Event</b> property is set to "mouseover". 
</p>

<p>
The default value of <b>Event</b> property is "click";
</p>
