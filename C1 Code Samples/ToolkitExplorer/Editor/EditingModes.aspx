<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.master" AutoEventWireup="true"
	CodeFile="EditingModes.aspx.cs" Inherits="Editor_EditingModes" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="server">
	<p>
	<strong>C1EditorExtender</strong> supports three editing views: design, source, and split. 
	The toolbar at the bottom of the Editor lets users switch between views.
	<strong>C1EditorExtender</strong> also supports a full screen editing mode in which the control resizes to fit the entire browser window (or parent frame). 
...
<asp:Content ID="Content5" ContentPlaceHolderID="ControlOptions" runat="server">
	<fieldset>
		<legend>Editing Modes </legend>
	...
	<script type="text/javascript">
		function switchview(index) {
			switch (index) {
				case 1:
					$("#<%= TextBox1.ClientID %>").wijeditor("executeEditorAction", "wysiwyg");
					break;
				case 2:
					$("#<%= TextBox1.ClientID %>").wijeditor("executeEditorAction", "code");
					break;
				case 3:
					$("#<%= TextBox1.ClientID %>").wijeditor("executeEditorAction", "split");
					break;
			}
		}
	</script>
