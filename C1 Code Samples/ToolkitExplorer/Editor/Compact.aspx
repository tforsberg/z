<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.master" AutoEventWireup="true"
	CodeFile="Compact.aspx.cs" Inherits="Editor_Compact" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="server">
	<p>
		<strong>C1EditorExtender</strong> supports compact ribbon. 
	</p>
	<p>
		When the width of ribbon is not enough to show all the ribbon button, editor will show
		the compact ribbon.
	</p>	
</asp:Content>
