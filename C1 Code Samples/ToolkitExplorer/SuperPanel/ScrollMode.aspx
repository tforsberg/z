<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.master" AutoEventWireup="true"
    CodeFile="ScrollMode.aspx.cs" Inherits="SuperPanel_ScrollMode" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:Panel ID="superpanel1" runat="server" Width="300px" Height="300px">
        <div class="elements">
            <ul>
    ...
    <asp:Panel ID="superpanel2" runat="server" Width="300px" Height="300px">
        <div class="elements">
            <ul>
                <li style="background: activeborder;"><span>ActiveBorder</span></li>
                <li style="background: activecaption;"><span>ActiveCaption</span></li>
    ...
    <h4>
        Edge Hover</h4>
    <asp:Panel ID="superpanel3" runat="server" Width="300px" Height="300px">
        <div class="elements">
            <ul>
                <li style="background: activeborder;"><span>ActiveBorder</span></li>
                <li style="background: activecaption;"><span>ActiveCaption</span></li>
                ...
                <li style="background: background;"><span>Desktop</span></li>
                <li style="background: graytext;"><span>GrayText</span></li>
                <li style="background: highlight; top: 0px; left: 0px;"><span>Highlight</span></li>
                <li style="background: highlighttext;"><span>HighlightText</span></li>
                <li style="background: highlight;"><span>HotTrack</span></li>
                <li style="background: inactiveborder;"><span>InactiveBorder</span></li>
                <li style="background: inactivecaption;"><span>InactiveCaption</span></li>
    ...
    <wijmo:C1SuperPanelExtender runat="server" ID="SuperPanelExtender1" TargetControlID="superpanel1" />
    <wijmo:C1SuperPanelExtender runat="server" ID="SuperPanelExtender2" TargetControlID="superpanel2"
        AllowResize="True">
        <AnimationOptions Easing="Swing"></AnimationOptions>
    ...
    <wijmo:C1SuperPanelExtender runat="server" ID="SuperPanelExtender3" TargetControlID="superpanel3">
        <AnimationOptions Easing="Swing"></AnimationOptions>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="server">
    <p>
        This sample shows how the <b>HScroller.ScrollMode</b> and <b>VScroller.ScrollMode</b>
        options can be used to determine the way the superpanel is scrolled. the possible values 
        are "Edge","Buttons","ButtonsHover","ScrollBar".
    </p>
    <ul>
        <li>Set property <b>HScroller.ScrollMode</b> to determine scroll mode of horizontal direction.</li>
        <li>Set property <b>VScroller.ScrollMode</b> to determine scroll mode of vertical direction.</li>
    </ul>
</asp:Content>
