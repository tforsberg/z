<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.master" AutoEventWireup="true"
    CodeFile="ClientSideAPI.aspx.cs" Inherits="SuperPanel_ClientSideAPI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="Server">
    ...
    <script id="scriptInit" type="text/javascript">
        function scroll(x, y) {
            ...
            $("#<%=superpanel.ClientID%>").wijsuperpanel('scrollTo', x, y);
        }
    </script>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="server">
    <p>This sample shows how you can scroll to a specified position at client side.</p><br/>
    <p>The scrollTo client side method is used to scroll the superpanel to specified position.<br/>
        For example: $("#superpanelId").wijsuperpanel('scrollTo', 100, 100);
    </p>
</asp:Content>
