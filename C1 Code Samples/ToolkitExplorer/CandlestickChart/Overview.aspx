<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.Master" AutoEventWireup="true" CodeBehind="Overview.aspx.cs" Inherits="ToolkitExplorer.CandlestickChart.Overview" %>
...
<asp:Panel runat="server" ID="panel1" Height="475" Width="756">
	...
	<wijmo:C1CandlestickChartExtender ID="Panel1_C1CandlestickChartExtender" 
			runat="server" Culture="en-US" TargetControlID="Panel1">
			 <SeriesList>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Description" runat="server">
    <p>
				This demo shows how to create simple candlestick chart.
            </p>
</asp:Content>
