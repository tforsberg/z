<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.Master" AutoEventWireup="true"
	CodeBehind="HighLow.aspx.cs" Inherits="ToolkitExplorer.CandlestickChart.HighLow" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<wijmo:C1CandlestickChartExtender ID="Panel1_C1CandlestickChartExtender" runat="server"
		Culture="en-US" TargetControlID="Panel1" Type="Hl">
		<SeriesList>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Description" runat="server">
	<p>
		This demo shows how to create candlestick chart with hl type.
	</p>
</asp:Content>
