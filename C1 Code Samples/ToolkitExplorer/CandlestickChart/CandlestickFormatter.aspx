<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.Master" AutoEventWireup="true"
	CodeBehind="CandlestickFormatter.aspx.cs" Inherits="ToolkitExplorer.CandlestickChart.CandlestickFormatter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<wijmo:C1CandlestickChartExtender ID="Panel1_C1CandlestickChartExtender" runat="server"
		Culture="en-US" TargetControlID="Panel1" Type="Ohlc" CandlestickFormatter="candlestickFormat">
		<SeriesList>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Description" runat="server">
	<p>
		This demo shows use <b>CandlestickFormatter</b> property to style the candlestick elements.
	</p>
</asp:Content>
