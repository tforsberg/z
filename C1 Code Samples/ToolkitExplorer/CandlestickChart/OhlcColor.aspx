<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.Master" AutoEventWireup="true" CodeBehind="OhlcColor.aspx.cs" Inherits="ToolkitExplorer.CandlestickChart.OhlcColor" %>
...
<asp:Panel runat="server" ID="panel1" Height="475" Width="756">
	...
	<wijmo:C1CandlestickChartExtender ID="Panel1_C1CandlestickChartExtender" 
			runat="server" Culture="en-US" TargetControlID="Panel1" Type="Ohlc">
<SeriesList>
		...
		<CandlestickChartSeriesStyles>
			<wijmo:CandlestickChartStyle>
				<HighLow Width="6">
					<Fill Color="#C8C8C8"></Fill>
				</HighLow>
				<Open Width="6" Height="10">
					<Fill Color="#C7B42E"></Fill>
				</Open>
				<Close Width="6" Height="10">
					<Fill Color="#7B3A96"></Fill>
				</Close>
			</wijmo:CandlestickChartStyle>
		</CandlestickChartSeriesStyles>
...
<p>
				This demo shows how to use <b>CandlestickChartSeriesStyles</b> property to set style.
			</p>
</asp:Content>
