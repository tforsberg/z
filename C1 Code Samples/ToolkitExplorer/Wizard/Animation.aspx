<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.master" AutoEventWireup="true" Inherits="Wizard_Animation" Codebehind="Animation.aspx.cs" %>
...
<p>
C1WizardExtender supports animation when opening or hiding page content.
</p>

<p>
Animation style when showing a page is determined by the <b>ShowOption</b> property.
Animation style when hiding a page is determined by the <b>HideOption</b> property.
</p>

<p>
To select or clear an animation, click the check box. 
To change the duration of the show option and hide option animations, click their respective Duration drop-down arrow and select a duration from the list.
</p>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ControlOptions" runat="server">
    ...
    $(document).ready(function () {
        $('.show').change(function () {
            $('#<%=Panel1.ClientID %>').wijwizard({ showOption: {
        ...
        $('.hide').change(function () {
            $('#<%=Panel1.ClientID %>').wijwizard({ hideOption: {
