<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.master" AutoEventWireup="true" 
	CodeFile="OverView.aspx.cs" Inherits="C1BarChart_OverView" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" Runat="Server">
	<p>
		This sample demonstrates a set of powerful features for the <strong>C1BarChart</strong>. This Bar Chart shows data that compares sales for 15 States.
	</p>
	<h3>Test the features</h3>
	<ul>
		<li>Hover over a bar to see the tooltip.</li>
		<li>Note the formatted Currency values in the tooltip.</li>
		<li>Note the X axis positioned at the top of the chart.</li>
	</ul>
</asp:Content>
