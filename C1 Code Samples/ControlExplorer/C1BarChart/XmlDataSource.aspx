<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.Master" AutoEventWireup="true" CodeBehind="XmlDataSource.aspx.cs" Inherits="C1BarChart_XmlDataSource" %>
...
<wijmo:C1BarChart ID="C1BarChart1" runat="server" DataSourceID="XmlDataSource1" Height="475px" Width = "756px" Culture="en-US">
...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="server">
	<p>This sample shows how to bind XmlDataSource to the <strong>C1BarChart</strong> control.</p>
</asp:Content>
