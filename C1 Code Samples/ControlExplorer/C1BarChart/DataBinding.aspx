<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.master" AutoEventWireup="true" 
	CodeFile="DataBinding.aspx.cs" Inherits="C1BarChart_DataBinding" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" Runat="Server">
	<p>The <strong>C1BarChart </strong>supports binding data from an external data source on the server.</p>
	<p>
	...
	<p>DataBindings is a collection that contains the <strong>C1ChartBinding</strong> instances.  
		<strong>C1ChartBinding </strong>includes the following properties:</p>
	<ul>
