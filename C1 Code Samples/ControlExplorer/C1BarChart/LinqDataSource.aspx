<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.Master" AutoEventWireup="true" CodeBehind="LinqDataSource.aspx.cs" Inherits="C1BarChart_LinqDataSource" %>
...
<wijmo:C1BarChart ID="C1BarChart1" runat="server" DataSourceID="LinqDataSource1" Height="475px" Width = "756px" Culture="en-US">
...
<GridMinor Visible="False"></GridMinor>
	...
	<asp:LinqDataSource ID="LinqDataSource1" runat="server" 
		...
		Select="new (Key as CategoryName, Sum(ProductSales) as Sales)">
	</asp:LinqDataSource>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="server">
	<p>This sample shows how to bind LinqDataSource to the <strong>C1BarChart</strong> control.</p>
</asp:Content>
