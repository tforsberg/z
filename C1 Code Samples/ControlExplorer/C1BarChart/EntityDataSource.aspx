<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.Master" AutoEventWireup="true" CodeBehind="EntityDataSource.aspx.cs" Inherits="C1BarChart_EntityDataSource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<wijmo:C1BarChart ID="C1BarChart1" runat="server" DataSourceID="EntityDataSource1" Height="475px" Width = "756px" Culture="en-US">
...
<GridMinor Visible="False"></GridMinor>
	...
	<asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=C1NWindEntities"
		 DefaultContainerName="C1NWindEntities" Select ="it.[CategoryName], Sum(it.[ProductSales]) AS Sales" OrderBy="it.[CategoryName]" 
         GroupBy="it.[CategoryName]" EntitySetName="Sales_by_Categories"></asp:EntityDataSource>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="server">
	<p>This sample shows how to bind EntityDataSource to the <strong>C1BarChart</strong> control.</p>
</asp:Content>
