<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.Master" AutoEventWireup="true" CodeBehind="Ohlc.aspx.cs" Inherits="ControlExplorer.C1CandlestickChart.Ohlc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<wijmo:C1CandlestickChart ID="C1CandlestickChart1" runat="server" Height="475" Width="756" Type="Ohlc">
		...
		<CandlestickChartSeriesHoverStyles>
			<wijmo:CandlestickChartStyle>
				<HighLow>
					<Fill Color="#DF5C24"></Fill>
				</HighLow>
				<Open>
					<Fill Color="#DF5C24"></Fill>
				</Open>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="server">
	<p>
		This demos shows how to create Ohlc type chart.
	</p>
</asp:Content>
