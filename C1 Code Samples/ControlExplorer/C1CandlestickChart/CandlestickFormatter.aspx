<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.Master" AutoEventWireup="true" CodeBehind="CandlestickFormatter.aspx.cs" Inherits="ControlExplorer.C1CandlestickChart.CandlestickFormatter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<wijmo:C1CandlestickChart ID="C1CandlestickChart1" runat="server" Height="475" Width="756" CandlestickFormatter="candlestickFormat" Type="Ohlc">
		<SeriesList>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="server">
	<p>
		This demo shows use of <b>CandlestickFormatter</b> property to style the candlestick elements.
	</p>
</asp:Content>
