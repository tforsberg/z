<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.Master" AutoEventWireup="true" CodeBehind="OhlcColor.aspx.cs" Inherits="ControlExplorer.C1CandlestickChart.OhlcColor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<wijmo:C1CandlestickChart ID="C1CandlestickChart1" runat="server" Height="475" Width="756" Type="Ohlc">
		<SeriesList>
