<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Wijmo.Master" CodeBehind="ValueLabels.aspx.cs" Inherits="ControlExplorer.C1CandlestickChart.ValueLabels" %>
	...
	<wijmo:C1CandlestickChart ID="C1CandlestickChart1" runat="server" Height="475" Width="756">
		...
		<Axis>
			<X AnnoMethod="ValueLabels">
				...
				<ValueLabelList>
					<wijmo:ValueLabel DateTimeValue="2011-12-01" Text="Monday"></wijmo:ValueLabel>
					<wijmo:ValueLabel DateTimeValue="2011-12-02" Text="Tuesday"></wijmo:ValueLabel>
					<wijmo:ValueLabel DateTimeValue="2011-12-05" Text="Wednesday"></wijmo:ValueLabel>
					<wijmo:ValueLabel DateTimeValue="2011-12-06" Text="Thursday"></wijmo:ValueLabel>
					<wijmo:ValueLabel DateTimeValue="2011-12-07" Text="Friday"></wijmo:ValueLabel>
				</ValueLabelList>
			</X>
