<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.Master" AutoEventWireup="true" CodeBehind="ColumnMoving.aspx.cs" Inherits="ControlExplorer.C1GridView.ColumnMoving" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<wijmo:C1GridView runat="server" ID="C1GridView1" AllowPaging="true" PageSize="15" AutogenerateColumns="False" DataSourceID="SqlDataSource1" AllowColMoving="true">
...
<asp:Content ID="Content4" ContentPlaceHolderID="Description" runat="server">
	<p>
		The C1GridView allows users to move columns when the <b>AllowColMoving</b> property is set to true. Users can move columns by dragging them by the column header. The grid provides visual feedback as columns are dragged.
	</p>
</asp:Content>
