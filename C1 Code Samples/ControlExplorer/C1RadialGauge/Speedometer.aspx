<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.Master" AutoEventWireup="true" CodeBehind="Speedometer.aspx.cs" Inherits="ControlExplorer.C1RadialGauge.Speedometer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<Wijmo:C1RadialGauge runat="server" ID="Gauge1" Value="90" StartAngle="300" SweepAngle="300">
		<Labels Offset="42">
...
<asp:Content ID="Content4" ContentPlaceHolderID="Description" runat="server">
	<p>This sample uses the <b>Range</b> and <b>Face</b> properties to style the gauge so it appear like a speedometer.</p>
</asp:Content>
