...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="Server">
    <p>
        C1Wizard supports posting back automatically if navigating between contents.
    </p>
    <p>
        Auto-postback is enabled by setting the <strong>AutoPostBack</strong> property to true.
    </p>
    <p>
        We can detect the change of actived index in the <strong>ActiveIndexChanged</strong> event.
    </p>
</asp:Content>
