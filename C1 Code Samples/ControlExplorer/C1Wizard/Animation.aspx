...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="Server">
    <p>
        The <strong>C1Wizard</strong> widget supports animations, which you can play around with in this sample. To select or clear an animation, click the check box. To change the duration of the show option and hide option animations, click their respective Duration drop-down arrow and select a duration from the list.
    </p>
</asp:Content>
