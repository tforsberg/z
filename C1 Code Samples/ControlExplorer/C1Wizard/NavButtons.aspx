...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="Server">
    <p>
        <strong>C1Wizard </strong>supports displaying navigation buttons on both left/right sides of the edge.
    </p>
    <p>
        Edge buttons are displayed if the <strong>NavButtons</strong> property is set to <strong>Edge</strong>.
    </p>
    <p>
        In an auto-play senario, we generally set the <strong>NavButtons</strong> property to <strong>None</strong>.
    </p>
</asp:Content>
