<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.master" AutoEventWireup="true" Inherits="C1Wizard_Simple" CodeBehind="Simple.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <wijmo:C1Wizard ID="C1Wizard1" runat="server" ShowStepHeader="false">
        <Steps>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="Server">
    <p>
        C1Wizard supports displaying contents without a tabbed interface.
    </p>
    <p>
        We can hide the step headers if the <strong>ShowStepHeader</strong> property is set to false.
    </p>
</asp:Content>
