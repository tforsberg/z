<%@ Page Title="" Language="C#" MasterPageFile="~/Wijmo.master" AutoEventWireup="true" Inherits="C1Tabs_Overview" CodeBehind="Overview.aspx.cs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="Server">
    <p>
        The <strong>C1Tabs</strong> is a control used to break content into multiple tabbed sections to save screen real estate.
    </p>
    <p>
        This sample depicts the default behavior of the<strong> C1Tabs</strong> control. Other samples in this section illustrate various features of the <strong>C1Tabs </strong>control, such as automatic postback and tab alignment.
    </p>
</asp:Content>
