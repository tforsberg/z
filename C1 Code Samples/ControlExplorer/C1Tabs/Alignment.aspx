...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="Server">
    <p>
        <strong>C1Tabs</strong> supports displaying tabs in Top, Bottom, Left, or Right alignment.
    </p>
    <p>
        This is determined by setting the <strong>Alignment</strong> property. Alignment defines where the tabs are positioned relative to the content pane.
    </p>
    <p>
        To change the alignment of the tabs in the sample, click the <strong>Alignment</strong> drop-down arrow and select an item from the list.
    </p>
</asp:Content>
